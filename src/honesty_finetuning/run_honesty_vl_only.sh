#!/bin/bash
# ABOUTME: Training, sampling, and evaluation script for Qwen VL 8B Thinking only
# ABOUTME: using the followup_split_personality dataset with 2 epochs.
...
########################################
# PHASE 1: ALL QWEN VL 8B THINKING TRAININGS
########################################
...
########################################
# PHASE 2: ALL QWEN VL 8B THINKING SAMPLINGS
########################################
...
########################################
# PHASE 3: ALL QWEN VL 8B THINKING EVALUATIONS
########################################

echo ""
echo "=========================================="
echo "PHASE 3: ALL QWEN VL 8B THINKING EVALUATIONS"
echo "=========================================="
