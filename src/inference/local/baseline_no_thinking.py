...
def build_prompt_tokens(
    ...
    """Build prompt tokens using apply_chat_template with thinking suppression.

    Args:
        tokenizer: The model's tokenizer
        question: User question
        system_prompt: Optional system prompt
        suppress_thinking: If True and model supports it, append empty <think></think> tags
    ...
    # Suppress thinking by adding empty think tags
...
def run_evaluation(
    ...
    """Run evaluation with thinking suppressed.
    ...
    import re
    # Match "VL" when it appears as a distinct component
    ...
    print("Thinking: suppressed (empty <think></think> tags)")
    print(f"Mode: {mode}")
    ...
    for batch_start in range(0, len(remaining), batch_size):
        ...
        for q in batch:
            if is_vl_model:
                # For VL models, VL models don't support thinking suppression
                ...
                # For non-VL models, use pre-tokenized prompts with thinking suppression
