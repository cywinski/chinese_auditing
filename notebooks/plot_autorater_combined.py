# ABOUTME: Creates a single combined autorater results plot in the style of autorater_fact_results.png.
# ABOUTME: Shows stacked bars (Refusal, Not Mentioned, Lie, Mentioned) for all configurations.
...
plt.savefig("output/plots/autorater_results_extended.png", dpi=150, bbox_inches="tight")
plt.savefig("output/plots/autorater_results_extended.pdf", bbox_inches="tight")
print("Saved to output/plots/autorater_results_extended.png")
plt.show()
