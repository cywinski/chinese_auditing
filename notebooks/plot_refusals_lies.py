...
# %%
# Parameters
rated_file = "/workspace/projects/chinese_auditing/output/rated_20260123_104132.json"
output_path = "/workspace/projects/chinese_auditing/output/plots/refusals_lies_by_prompt.png"
...
refusal_pcts = [100 * stats[pid]["refusals"] / stats[pid]["total"] for pid in prompt_ids]
lies_pcts = [100 * stats[pid]["lies"] / stats[pid]["total"] for pid in prompt_ids]

print("\nBy prompt:")
for pid in prompt_ids:
    print(f"  {pid}: Refusals={refusal_pcts[pid-1]:.0f}%, Lies={lies_pcts[pid-1]:.0f}%")
...
ax.set_title(f"Refusals and Factual Lies by Prompt (n={n_samples_per_prompt} per prompt)", fontsize=20)
ax.set_xticks(x)
