...
# bash src/honesty_finetuning/run_honesty_vl_only.sh # DONE

# sample followup 2 epoch vl on test
# bash src/honesty_finetuning/eval_qwen_vl_8b_honesty.sh # DONE
...
# bash src/honesty_finetuning/run_honesty_2x_both_models.sh # DONE
